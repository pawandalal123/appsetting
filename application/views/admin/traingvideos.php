...
<div class="col-md-9">
<input type="text" id="videourl" name="videourl" class="form-control validate[required,custom[url]]" placeholder="Enter Category Name"  value="<?php echo @$editdata->video_link;?>" />
<?php echo form_error("videourl"); ?>
</div>
</div>
...
<td><?php echo $result->video_title;?></td>
