...
<?php echo $this->session->userdata('msg');?></span>
 <?php $this->session->unset_userdata('msg');}?>
          ...
          <form action="#" method="post">
           <div class="row01"><input type="password" class="input" placeholder="Old Password" name="oldpassword">
                <?php echo form_error('oldpassword');?>
                 </div>
                <div class="row01"><input type="password" class="input" placeholder="New Password" name="npassword">
               ...
               <!--  <span class="error-msg">Please enter valid text</span>
                ...
                <div class="row01">
                <input type="password" class="input" placeholder="Retype new Password" name="repassword"> 
